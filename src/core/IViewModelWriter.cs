...
namespace CR.ViewModels.Core
{
    ...
    public interface IViewModelWriter
    {
        ...
        /// <exception cref="DuplicateKeyException">Exception will be thrown when the given key for a
        /// view model of type TEntity is already stored in the view model storage for this </exception>
        void Add<TEntity>(string key, TEntity entity)
            where TEntity : class;

        /// <summary>
        /// Attempts to update the specified view model of type TEntity in the view model storage
        ...
        /// <exception cref="EntityNotFoundException">Exception will be thrown when attempting to update
        /// a key that is not present in the view model storage</exception>
        void Update<TEntity>(string key, Action<TEntity> update)
            where TEntity : class;

        /// <summary>
        /// Attempts to update all view models of type TEntity in the view model storage matching the provided expression
        /// using the provided delegate.
        /// </summary>
        ...
        /// <summary>
        /// Attempts to delete the specified view model of type TEntity from the view model storage
        /// using the provided delegate.
        /// </summary>
        ...
        /// <exception cref="ArgumentException">Exception will be thrown whenever an empty string is passed in for parameter key.</exception>
        /// <exception cref="EntityNotFoundException">Exception will be thrown when attempting to delete
        /// a key that is not present in the view model storage</exception>
