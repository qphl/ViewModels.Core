...
REM Build
%WINDIR%\Microsoft.NET\Framework\v4.0.30319\msbuild src\cr-viewmodels.sln /p:Configuration="%config%" /m /v:M /fl /flp:LogFile=msbuild.log;Verbosity=Normal /nr:false
